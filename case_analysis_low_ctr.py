...
if __name__ == '__main__':
    ...
    print(cwd)
    gsb = open(cwd+'/case_analysis/low_ctr.csv', 'w', encoding='utf-8')
    size = 20
    ...
    path_sample = cwd+"/data/sample_keywords_low_ctr.json"
    ...
    with open(path_sample, "r", encoding='utf-8') as f:
        for idx,l in enumerate(f.readlines()):
            ...
            gsb.write(
                '[query] '+ r['keyword'] + '\t[expo] {}\t'.format(r['expo']) + '\t[ctr_cc] {}\t'.format(r['ctr_cc']) + \
                    '\t[ctr_cart] {}\t'.format(r['ctr_cart']) + \
