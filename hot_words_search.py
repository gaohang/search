...
if __name__ == '__main__':
    hot_words = HotWordsSearch(['hot_words_online'])
    params = {
        "guids": {
    ...
    t = time.time()
    result = hot_words.search(params)
    print(result)
